...
const iconDefinitions: IconDefinition[] = [
  {
    ...
    iconSvg: (
      ...
      >
        <path
          d="M2 18C1.45 18 0.979167 17.8042 0.5875 17.4125C0.195833 17.0208 0 16.55 0 16V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H16C16.55 0 17.0208 0.195833 17.4125 0.5875C17.8042 0.979167 18 1.45 18 2V16C18 16.55 17.8042 17.0208 17.4125 17.4125C17.0208 17.8042 16.55 18 16 18H2ZM2 15.0643C2 15.5811 2.41891 16 2.93567 16H15.0643C15.5811 16 16 15.5811 16 15.0643V12H13C12.5 12.6333 11.9042 13.125 11.2125 13.475C10.5208 13.825 9.78333 14 9 14C8.21667 14 7.47917 13.825 6.7875 13.475C6.09583 13.125 5.5 12.6333 5 12H2V15.0643ZM9 12C9.53333 12 10.025 11.8625 10.475 11.5875C10.925 11.3125 11.2917 10.95 11.575 10.5C11.675 10.35 11.8 10.2292 11.95 10.1375C12.1 10.0458 12.2667 10 12.45 10H16V2.93567C16 2.41892 15.5811 2 15.0643 2H2.93567C2.41892 2 2 2.41891 2 2.93567V10H5.55C5.73333 10 5.9 10.0458 6.05 10.1375C6.2 10.2292 6.325 10.35 6.425 10.5C6.70833 10.95 7.075 11.3125 7.525 11.5875C7.975 11.8625 8.46667 12 9 12Z"
          fill="white"
          fill-opacity="0.6"
        />
      </svg>
      ...
      >
        ...
        >
          <circle
            ...
            cy="20"
            r="100"
            stroke="rgba(126, 224, 255, 0.98)"
            strokeWidth="1.1"
            strokeLinecap="round"
            strokeDasharray="238 26"
            fill="none"
          />
          <circle
            cx="180"
...
function normalizeApiPayload(
  ...
  if (iconId === "workflows" && Array.isArray(payload.todos))
